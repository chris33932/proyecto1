...
class Oferta
{
     ...
     * @var string
     *
     * @ORM\Column(name="descuento", type="decimal", precision=2, scale=1, nullable=true)
     */
    private $descuento;
    ...
    private $revisada;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Ciudad", inversedBy="ofertas")
   ...
   /**
    * @ORM\ManyToOne(targetEntity="Tienda", inversedBy="ofertas")
